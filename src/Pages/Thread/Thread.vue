       ...
       <div class="relative md:border-b-2 md:border-light-100 pb-3">
           ...
           <div  class="relative flex">
               <div class="px-6 flex-1">
                   ...
                   <!-- comment form -->
                   <form action="" class="flex gap-x-1 bg-light-100 rounded-md py-2 px-2 mb-4">
                      <input type="text" name="" id="" placeholder="comment" class="bg-transparent px-2 py-1 outline-none flex-1">
                      <button type="submit">
