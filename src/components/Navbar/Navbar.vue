          ...
          <div class="flex items-center gap-x-6">
            ...
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                ...
                <button @click="handleOpenMenu" type="button" class="flex text-sm  rounded-full md:me-0 outline-0 border-2 border-bubble " id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                 ...
                 <!-- Dropdown menu -->
                  <div v-if="isOpen" class="absolute top-10 hidden lg:block z-50  my-4 text-base list-none bg-dark-900 divide-y rounded-lg shadow divide-gray-600 transition-all duration-300 ease-in" id="user-dropdown">
                          <div class="px-4 py-3">
...
<!-- 
<v-icon name="gi-three-burning-balls"  -->